...
class Instabot:
    def __init__(self):
        ...
        self.blacklist_usertags         = ["alex","lukas","michael","daniel","philipp","jonas","fabian","marcel","tim","kevin","jan","david","tom","markus","sebastian","julian","leon","christoph","simon",
                                            "felix","andreas","nils","nico","martin","max","florian","dennis","patrick","thomas","christopher","moritz","nick","chris","paul","jonathan","tobias","jakob","christian",                                            
                                            ...
                                            "stefan","martin","photo","fitness","traveller","wedding","food","guy","click","city","design","artwork","world","traveller","backpack","atelier","beard","blog","beautiful","beauty",
